...
A set of Jupyter notebooks that:
1.  Curate and tag key academic literature on Palestinian resilience.
2.  Analyze and visualize publicly available datasets on health, infrastructure, or quality of life.

## Quick Start
1.  Clone this repo: `git clone https://github.com/Dours-d/palestine-resilience-research.git`
2.  Install dependencies: `pip install -r requirements.txt`
3.  Launch Jupyter: `jupyter lab notebooks/`
4.  Open and run `01_literature_review.ipynb`
